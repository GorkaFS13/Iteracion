	...
	private void jButtonCreate_actionPerformed(ActionEvent e) {
		...
		if (error!=null)
			...
			try {
				...
				System.out.println(fieldOrigin.getText() + ", " + fieldDestination.getText() + ", " +  UtilDate.trim(jCalendar.getDate()) + ", " + inputSeats + ", " +  price + ", " +  driver.getUsername());
				Ride r=facade.createRide(fieldOrigin.getText(), fieldDestination.getText(), UtilDate.trim(jCalendar.getDate()), inputSeats, price, driver.getUsername());
